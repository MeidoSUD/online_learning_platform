  ...
  return (
    <div className="animate-fade-in bg-white" dir="rtl">
       <section className={s.hero}>
        <div className="absolute top-0 right-0 w-1/3 bg-navy/10 h-full -skew-x-12 transform translate-x-20 z-0 hidden lg:block" />
        <div className={`${s.container} grid grid-cols-1 lg:grid-cols-2 gap-12 items-center`}>
          <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            <div className={s.badge}>
              <Zap size={18} className="text-navy fill-navy" />
              <span className="text-sm font-bold text-navy tracking-wide uppercase font-poppins">EWAN ECOSYSTEM</span>
            </div>
            <h1 className={s.heroTitle}>
              نظام ايوان <br /><span className="text-navy">التعليمي الذكي</span>
            </h1>
            <p className="text-2xl md:text-3xl font-cairo text-slate-500 mb-8 font-medium text-right">
              ...
              <span className="text-green">التحول الرقمي المتكامل للمدارس</span>
            </p>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} className="relative">
             <div className="grid grid-cols-2 gap-6 h-[500px]">
                <div className="bg-navy rounded-3xl overflow-hidden shadow-2xl h-full"><img src="https://images.unsplash.com/photo-1571260899304-425eee4c7efc?auto=format&fit=crop&q=80&w=800" className="w-full h-full object-cover" /></div>
                <div className="flex flex-col gap-6">
                   <div className="flex-1 bg-green rounded-3xl overflow-hidden shadow-xl"><img src="https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&q=80&w=800" className="w-full h-full object-cover" /></div>
      ...
      <section className="py-24 bg-white">
         <div className={s.container}>
            <div className="text-center mb-16">
               <h2 className="text-5xl font-black font-cairo mb-4 text-slate-800">مكونات النظام <span className="text-navy">| Modules</span></h2>
               <div className="h-1.5 w-32 bg-green mx-auto rounded-full" />
            </div>
         ...
         <div className={`${s.container} grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center`}>
            {[
              ...
              <div key={i} className={s.statCard}>
                 <div className="text-5xl font-black text-navy mb-4">{stat.val}</div>
